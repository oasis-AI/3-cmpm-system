  ...
  <div>
    ...
    <el-dialog v-model="dialogVisible" :title="editItem ? '编辑活动' : '创建活动'" width="520px">
      <el-form :model="form" label-width="90px" style="padding-right:20px">
        ...
        <el-form-item label="开始时间"><el-date-picker v-model="form.start_time" type="datetime" format="YYYY-MM-DD HH:mm" value-format="YYYY-MM-DD HH:mm:ss" /></el-form-item>
        <el-form-item label="结束时间"><el-date-picker v-model="form.end_time" type="datetime" format="YYYY-MM-DD HH:mm" value-format="YYYY-MM-DD HH:mm:ss" /></el-form-item>
      </el-form>
      <template #footer>
